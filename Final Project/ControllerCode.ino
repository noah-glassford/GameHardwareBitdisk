...
//LIBRARY DOWNLOAD: https://github.com/MHeironimus/ArduinoJoystickLibrary
#include <Joystick.h>
...
int const BTN_A_PIN = 3;
int const BTN_B_PIN = 6;
int const BTN_C_PIN = 4;
int const BTN_D_PIN = 8;
int const BTN_E_PIN = 7;
int const BTN_F_PIN = 5;
int const BTN_H_PIN = 16;
int const AXIS_X_PIN = A1;
int const AXIS_Y_PIN = A2;
